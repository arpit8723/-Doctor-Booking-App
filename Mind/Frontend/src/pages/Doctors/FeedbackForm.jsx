                ...
                How would you rate the overall experience?*
                 ...
                 <div>
                    {[...Array(5).keys()].map((_,index)=> {
                        ...
                        return <button keys={index} type="button" className={`${index <= ((rating && hover) || hover) ?'text-yellowColor' :'text-gray-400' } bg-transparent border-none outline-none text-[22px] cursor-pointer`} 
